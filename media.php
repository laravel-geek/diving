    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-image'></i> Загрузить аватар <?php echo $user['name'];?>
            </h1>

        </div>
        <form  enctype="multipart/form-data" method="post" action="media_handler.php">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="avatar/<?php echo $user['avatar'];?>" alt="" class="img-responsive" width="200">
                                </div>
